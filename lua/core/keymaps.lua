...
vim.keymap.set('n', '<leader>se', '<C-w>=', opts) -- Split window vertical
vim.keymap.set('n', '<leader>xs', ':close<CR>', opts) -- Split window vertical
...
vim.keymap.set('n', '<leader>tx', ':tabn<CR>', opts) -- go to next tab
